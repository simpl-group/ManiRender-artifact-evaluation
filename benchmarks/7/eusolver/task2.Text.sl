...
(declare-var x56 OBJ)
(declare-var x89 OBJ)
(declare-var x130 OBJ)

; facts
; userdefined args = {'Text': {'StartsWith': ['NH', 'XL', 'DV'], 'Regex': ['[a-zA-Z]{2,2}\\d{3,3}']}}
...
(constraint (= (Respect {"id": 56, "cls": "Text", "Context": "DV1562", "Empty": False, "PureNumber": False, "PureAlphabet": False, "Length": 6}) false))
(constraint (= (Respect {"id": 89, "cls": "Text", "Context": "XL1033", "Empty": False, "PureNumber": False, "PureAlphabet": False, "Length": 6}) false))
(constraint (= (Respect {"id": 130, "cls": "Text", "Context": "NH7283", "Empty": False, "PureNumber": False, "PureAlphabet": False, "Length": 6}) false))
