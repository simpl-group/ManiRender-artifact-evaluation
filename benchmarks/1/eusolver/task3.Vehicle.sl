...
; facts
; userdefined args = {}
(constraint (= (Respect {"id": 1, "cls": "Vehicle", "Color": "Blue", "Type": "Sedan"}) true))
(constraint (= (Respect {"id": 4, "cls": "Vehicle", "Color": "Black", "Type": "Motor"}) true))
...
(constraint (= (Respect {"id": 17, "cls": "Vehicle", "Color": "White", "Type": "Sedan"}) true))

(constraint (= (Respect {"id": 2, "cls": "Vehicle", "Color": "Black", "Type": "Sedan"}) false))
(constraint (= (Respect {"id": 7, "cls": "Vehicle", "Color": "Blue", "Type": "Hatchback"}) false))
(constraint (= (Respect {"id": 8, "cls": "Vehicle", "Color": "Gray", "Type": "Sedan"}) false))
(constraint (= (Respect {"id": 10, "cls": "Vehicle", "Color": "Black", "Type": "Suv"}) false))
(constraint (= (Respect {"id": 14, "cls": "Vehicle", "Color": "Red", "Type": "Hatchback"}) false))
