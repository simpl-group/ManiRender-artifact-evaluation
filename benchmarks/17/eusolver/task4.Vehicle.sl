...
(constraint (= (Respect {"id": 7, "cls": "Vehicle", "Color": "Black", "Type": "Suv"}) true))
(constraint (= (Respect {"id": 10, "cls": "Vehicle", "Color": "White", "Type": "Pickup"}) true))
(constraint (= (Respect {"id": 11, "cls": "Vehicle", "Color": "White", "Type": "Suv"}) true))
(constraint (= (Respect {"id": 18, "cls": "Vehicle", "Color": "White", "Type": "Hatchback"}) true))
(constraint (= (Respect {"id": 19, "cls": "Vehicle", "Color": "Black", "Type": "Hatchback"}) true))
(constraint (= (Respect {"id": 24, "cls": "Vehicle", "Color": "Golden", "Type": "Hatchback"}) true))
(constraint (= (Respect {"id": 25, "cls": "Vehicle", "Color": "Gray", "Type": "Suv"}) true))
(constraint (= (Respect {"id": 27, "cls": "Vehicle", "Color": "Blue", "Type": "Hatchback"}) true))
(constraint (= (Respect {"id": 38, "cls": "Vehicle", "Color": "Golden", "Type": "Suv"}) true))
(constraint (= (Respect {"id": 43, "cls": "Vehicle", "Color": "Green", "Type": "Pickup"}) true))
