...
(constraint (= (Respect {"id": 7, "cls": "Vehicle", "Color": "Green", "Type": "Sedan"}) true))
...
(constraint (= (Respect {"id": 4, "cls": "Vehicle", "Color": "Black", "Type": "MPV"}) false))
(constraint (= (Respect {"id": 6, "cls": "Vehicle", "Color": "Gray", "Type": "Sedan"}) false))
(constraint (= (Respect {"id": 10, "cls": "Vehicle", "Color": "White", "Type": "Sedan"}) false))
