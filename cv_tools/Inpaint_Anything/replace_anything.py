...
try:
    ...
    from cv_tools.Inpaint_Anything.utils import load_img_to_array, save_array_to_img, dilate_mask, \
        show_mask, show_points, get_clicked_point
...
if __name__ == "__main__":
    ...
    for idx, mask in enumerate(masks):
        ...
        img_replaced = replace_img_with_sd(img, mask, args.text_prompt, device=device)
